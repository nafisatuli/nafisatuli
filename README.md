...
### I'm Nafisa Hasan Tuli

Machine learning engineer & full-stack software developer based in London. I'm an **IEEE-published researcher** currently completing an **MSc in Computer Science** (First-Class BSc, Chairman's Scholar), with **3+ years of production software experience** delivering full-stack systems for UK and European clients.
...
📫 Find me on [LinkedIn](https://www.linkedin.com/in/nafisa-hasan-0034).

### 🏆 Highlights
- ⚡ Optimised a high-value payment pipeline's API response time by **62%** (1.8s → 690ms) via query tuning & connection pooling.
- 🚀 Cut MongoDB aggregation query time by **78%** on a platform sustaining **8,000+** concurrent users.
